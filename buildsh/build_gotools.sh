...
ver=v0.14.1
curl -s https://repo.haplat.net/go/golang.org/x/tools/gopls/@v/ | grep 'v[0-9.]*info'
...
ver=v1.6.0
curl -s https://repo.haplat.net/go/github.com/cweill/gotests/@v/ | grep 'v[0-9.]*info'
...
ver=v1.16.0
curl -s https://repo.haplat.net/go/github.com/fatih/gomodifytags/@v/ | grep 'v[0-9.]*info'
...
ver=v1.2.0
curl -s https://repo.haplat.net/go/github.com/josharian/impl/@v/ | grep 'v[0-9.]*info'
...
ver=v1.0.0
curl -s https://repo.haplat.net/go/github.com/haya14busa/goplay/@v/ | grep 'v[0-9.]*info'
...
ver=v1.21.0
curl -s https://repo.haplat.net/go/github.com/go-delve/delve/@v/ | grep 'v[0-9.]*info'
...
ver=v0.4.5
curl -s https://repo.haplat.net/go/honnef.co/go/tools/@v/ | grep 'v[0-9.]*info'
...
ver=v0.3.28
curl -s https://repo.haplat.net/go/github.com/google/gops/@v/ | grep 'v[0-9.]*info'
...
curl -s https://repo.haplat.net/go/golang.org/x/lint/@v/ | grep 'v[0-9.]*info'
