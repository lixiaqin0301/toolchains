...
./configure --prefix=/home/lixq/toolchains/node20-${ver} --shared --debug --debug-node --debug-lib --gdb --v8-non-optimized-debug --v8-with-dchecks --v8-enable-object-print || exit 1
bear -- make || exit 1
rm -rf /home/lixq/toolchains/node20-${ver}
make install || exit 1
cd /home/lixq/toolchains/node20-${ver}/lib || exit 1
ln -s libnode.so.* libnode.so
cp /home/lixq/workspace-vscode/node-${ver}/deps/v8/include/v8-inspector*.h /home/lixq/toolchains/node20-${ver}/include/node/
