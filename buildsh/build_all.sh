...
build_packages 8.15.0 /home/lixq/toolchains/curl zlib zstd openssl nghttp3 ngtcp2 nghttp2 libssh2 brotli #  keyutils krb5 libidn2 openldap libunistring libpsl gsasl curl
