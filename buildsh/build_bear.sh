...
if [[ ! -f /home/lixq/src/json-v${nlohmannjsonver}.tar.gz ]]; then
...
rm -rf Bear-${ver}
tar -xf /home/lixq/src/Bear-${ver}.tar.gz
cd /home/lixq/src/Bear-${ver} || exit 1
mkdir -p build/subprojects/Download/fmt_dependency/
cp -f /home/lixq/src/fmt-${fmtver}.tar.gz build/subprojects/Download/fmt_dependency/${fmtver}.tar.gz
mkdir -p build/subprojects/Download/googletest_dependency/
cp -f /home/lixq/src/googletest-${googletestver}.tar.gz build/subprojects/Download/googletest_dependency/v${googletestver}.tar.gz
...
cp -f /home/lixq/src/grpc-v${grpcver}.tar.gz build/subprojects/Download/grpc_dependency/v${grpcver}.tar.gz
mkdir -p build/subprojects/Download/nlohmann_json_dependency/
cp -f /home/lixq/src/json-v${nlohmannjsonver}.tar.gz build/subprojects/Download/nlohmann_json_dependency/v${nlohmannjsonver}.tar.gz
mkdir -p build/subprojects/Download/spdlog_dependency/
cp -f /home/lixq/src/spdlog-v${spdlogver}.tar.gz build/subprojects/Download/spdlog_dependency/v${spdlogver}.tar.gz
mkdir -p build
cd build || exit 1
